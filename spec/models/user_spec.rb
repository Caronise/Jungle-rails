...
RSpec.describe User, type: :model do
  ...
  describe 'Validations' do
    subject { described_class.new(first_name: "Micheal", last_name: "Oldfield", email: "test@test.com", password: "alpha1", password_confirmation: "alpha1") }
    user = described_class.new(first_name: "test", last_name: "test", email: "test@test.com", password: "12345", password_confirmation: "12345")
  ...
  describe ".authenticate_with_credentials" do
    subject { described_class.new(first_name: "Bruno", last_name: "Mars", email: "test@test.com", password: "azerty", password_confirmation: "azerty") }
